...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // dependencies from the compile classpath, so Dispatchers/withContext in
            // androidMain would not resolve through compose.runtime.
...
android {
    namespace = "com.automatelinux.tally.shared"
    compileSdk = 35
    defaultConfig {
        minSdk = 26
    }
